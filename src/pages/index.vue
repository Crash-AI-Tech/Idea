<template>
  <div class="container mx-auto px-4 py-8">
      ...
      <div class="mb-4">
        ...
        <div class="flex flex-wrap gap-2">
          ...
          <button
            ...
            class="px-3 py-1 rounded-full text-sm"
            :class="selectedTag === tag ? 'bg-primary-green text-white' : 'bg-tech-gray-100 text-tech-gray-700 hover:bg-tech-gray-200'"
          >
            {{ tag }}
          </button>
        </div>
    ...
    <!-- 空状态 -->
    <div v-else-if="filteredIdeas.length === 0" class="text-center py-16 bg-tech-gray-50 rounded-lg shadow-sm border border-tech-gray-200">
      <svg xmlns="http://www.w3.org/2000/svg" class="h-16 w-16 mx-auto text-tech-gray-400 mb-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
async function fetchIdeas() {
  try {
    ...
    const { data, error } = await supabase
      .from('ideas')
      .select(`
        id, title, description, user_id, created_at, tags,
        likes:likes(count),
